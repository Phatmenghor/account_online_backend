...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAllExceptions(Exception ex) {
        // CRITICAL: Skip OTP exceptions - let OtpExceptionHandler handle them
        if (ex instanceof OtpAttemptsExceededException ||
                ex instanceof OtpInvalidException ||
                ex instanceof OtpCooldownException ||
                ex instanceof OtpNotFoundException) {
            throw (RuntimeException) ex; // Re-throw to let OtpExceptionHandler catch it
        }
