...
public class OpenAccountAmlStatusMapper {
    ...
    public AmlStatusDto toDto(AmlStatus entity) {
        ...
        return AmlStatusDto.builder()
                ...
                .totalRulesScore(entity.getAmlExternalTotalRulesScore() == null ? 0 : entity.getAmlExternalTotalRulesScore())
    ...
    public AmlStatusDto fromRequestAndResponse(
        ...
        return AmlStatusDto.builder()
                ...
                .currentAddressName(currentAddr != null ? masterDataServiceHelper.buildFullAddressName(currentAddr) : null)
                .currentAddressCode(currentAddr != null ? masterDataServiceHelper.buildFullAddressCode(currentAddr) : null)
                .placeOfBirthName(pobAddr != null ? masterDataServiceHelper.buildFullAddressName(pobAddr) : null)
                .placeOfBirthCode(pobAddr != null ? masterDataServiceHelper.buildFullAddressCode(pobAddr) : null)
